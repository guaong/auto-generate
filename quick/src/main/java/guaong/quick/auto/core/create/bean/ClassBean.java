...
public class ClassBean {
     ...
     * class的类型
     *
     * @see guaong.quick.auto.core.create.creator.JavaCreator#TYPE_CLASS
     * @see guaong.quick.auto.core.create.creator.JavaCreator#TYPE_INTERFACE
     * @see guaong.quick.auto.core.create.creator.JavaCreator#TYPE_ENUM
     * @see guaong.quick.auto.core.create.creator.JavaCreator#TYPE_ANNOTATION
     */
