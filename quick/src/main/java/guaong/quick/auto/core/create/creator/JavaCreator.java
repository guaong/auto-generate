...
import guaong.quick.auto.core.exception.InitException;
import guaong.quick.auto.core.exception.TypeErrorException;
import guaong.quick.auto.core.resovle.bean.TableDefinition;
import guaong.quick.auto.core.translate.translator.JavaTranslator;
import guaong.quick.auto.core.util.Log;
...
//    @Override
//    public String convert2CamelCase(String name) {
//        if (name != null) {
...
//    }
//
//    public String convert2JClassName(String name) {
//        String str = this.convert2CamelCase(name);
//        if (str != null) {
